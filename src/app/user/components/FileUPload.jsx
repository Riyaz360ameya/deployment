        ...
        <div className='p-2 mt-5 rounded'>
            ...
            <div className='grid grid-cols-2 gap-6 p-2 mx-2 my-2 mb-6 overflow-hidden bg-gray-800 rounded md:grid-cols-3'>
                {fileInputs.map((label, index) => (
                    <div key={index}>
                        <label className='block mb-2 text-sm text-white font-medium text-gray-900 dark:text-white' htmlFor={`fileInput_${index}`}>
                            {label}
                        </label>
                        <input
...
// const FileUpload = ({ addToLocation, removeFromLocation, files, setFiles }) => {
//     // Data for file inputs
//     const fileInputs = [
//         '3DsMax - Building',
//         '3DsMax - Landscape & Textures',
...
//                 {fileInputs.map((label, index) => (
//                     <div key={index}>
//                         <label className='block mb-2 text-sm font-medium text-gray-900 dark:text-white text-white' htmlFor={`fileInput_${index}`}>
//                             {label}
//                         </label>
//                         <input
//                             className='block w-full text-lg text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400'
