                ...
                <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
                    ...
                    <div>
                        ...
                        <ul className="mb-6 flex flex-col gap-1.5">
                                ...
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            ...
                                            {/* <!-- Dropdown Menu Start --> */}
                                            <div
                                                className={`translate transform text-white overflow-hidden ${!open && "hidden"
                                                    }`}
                                            >
                            ...
                            <li>
                                <Link
                                    href="/calendar" passHref
                                    className={`group relative flex text-white items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("calendar") &&
                                        "bg-graydark dark:bg-meta-4"
                                        }`}
                                >
                                    <svg
                            ...
                            <li>
                                <Link
                                    href="/profile"
                                    className={`group relative flex text-white items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("profile") && "bg-graydark dark:bg-meta-4"
                                        }`}
                                >
                                    <svg
                                        className="fill-current"
                                ...
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            ...
                                            >
                                                <ul className="mb-5.5 text-white mt-4 flex flex-col gap-2.5 pl-6">
                                                    <li>
                                                        <Link
                                                            href="/" passHref
                            ...
                            <li>
                                <Link
                                    href="/tables" passHref
                                    className={`group relative flex text-white items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("tables") && "bg-graydark dark:bg-meta-4"
                                        }`}
                                >
                                    <svg
                                        className="fill-current"
                            ...
                            <li>
                                <Link
                                    href="/"
                                    className={`group relative flex text-white items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("settings") &&
                                        "bg-graydark dark:bg-meta-4"
                                        }`}
                                >
                                    <svg
                    ...
                    <div>
                        ...
                        <ul className="mb-6 flex flex-col gap-1.5">
                            ...
                            <li>
                                <Link
                                    href="/chart" passHref
                                    className={`group text-white relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("chart") && "bg-graydark dark:bg-meta-4"
                                        }`}
                                >
                                    <svg
                                        className="fill-current"
                            ...
                            <SidebarLinkGroup
                                activeCondition={pathname === "/" || pathname.includes("ui")}
                            >
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <Link
                                                href="#" passHref
                                                className={`group relative text-white flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "/ui" || pathname.includes("ui")) &&
                                                    "bg-graydark dark:bg-meta-4"
                                                    }`}
                                                onClick={(e) => {
                                                    e.preventDefault();
                                ...
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <Link
                                                href="/" passHref
                                                className={`group relative text-white flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "/auth" || pathname.includes("auth")) &&
                                                    "bg-graydark dark:bg-meta-4"
                                                    }`}
                                                onClick={(e) => {
                                                    e.preventDefault();
                                            ...
                                            >
                                                <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6 text-white">
                                                    <li>
                                                        <Link
                                                            href="/"
