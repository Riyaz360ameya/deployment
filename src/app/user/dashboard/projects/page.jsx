                ...
                <>
                    <div className='p-2 h-full overflow-hidden  w-full overflow-x-hidden'>
                        ...
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            <div class="pb-4 px-4 bg-white dark:bg-gray-900 py-5">
                                    ...
                                    <tr>
                                        <th scope="col" class="p-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-all-search" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-
