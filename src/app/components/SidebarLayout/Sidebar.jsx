    ...
    return (
        ...
        >
            ...
            <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
                                    ...
                                    <li key={i} className={`${item.gap ? 'mt-4 md:mt-9' : 'mt-0 md:mt-2'}`} >
                                        <p className='text-gray-400 text-sm hidden md:flex'> {item.title}</p>
                                        {
                                            item.list.map((each, i) => (
                                                <Link href={each.path} className={`flex items-center gap-x-4 w-full p-3 hover:bg-slate-400 rounded-md`}>
                ...
                {/* <!-- Sidebar Menu --> */}
                <div class="mx-auto mb-10  max-w-60 rounded-sm  bg-boxdark  px-4 py-6 text-center shadow-default bottom-0">
