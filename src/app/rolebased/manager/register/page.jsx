  ...
  return (
    ...
    <div className='absolute md:w-[40%] p-5'>
       ...
       <div className='flex items-center gap-5 justify-center'>
            ...
            <div>
                <button className='bg-gray-900 text-white rounded-md p-2 w-full mt-5 font-bold' onClick={managerRegister}>
                {loading ? <BeatLoader color='white' /> : "Register"}
                </button>
            </div>
            <div className=' mt-5'>
                <p className='text-black font-bold underline cursor-pointer'>
                    Already have an account? <Link href='/rolebased/manager/login'><span className='font-bold text-black'>Login</span></Link>
                </p>
            </div>
       </div>
    </div>
